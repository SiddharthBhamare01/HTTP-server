...
def do_head(parsed_req):
    ...
    if status_code!='404':
        ...
        if status_code!='200':
            return request_with_error(parsed_req,status_code,True)
